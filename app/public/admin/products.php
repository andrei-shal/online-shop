...
<html lang="ru">
    <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
        <script type="module" src="/admin/script/products.js"></script>

        <link href="/admin/style/products-content.css" rel="stylesheet">
    </head>
    <body>
        ...
        <div class="container pb-5">
            <div class="d-flex align-items-center justify-content-between mb-5">
                <div>
                    <h1 class="fw-bold tracking-tight mb-1">Управление товарами</h1>
                </div>
            </div>
            ...
            <form id="filter-form" class="card border-0 bg-light p-4 rounded-4 mb-5 shadow-sm">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="/admin/products.php" class="btn btn-outline-secondary px-4 rounded-3 fw-medium">Сбросить</a>
                    <button type="submit" class="btn btn-primary px-4 rounded-3 fw-semibold">Применить</button>
                    <a href="/admin/create-product.php" class="btn btn-primary px-4 rounded-3 fw-semibold">Создать</a>
                </div>
            </form>
